  ...
  return (
    <footer className="bg-[#faf8f5] pb-12 relative" style={footerStyle}>
      ...
      <div className="fixed bottom-6 right-6 flex flex-col gap-4 z-50">
        ...
        {whatsappActive && (whatsappNumber || companyPhone) && (
          <a href={`https://wa.me/${(whatsappNumber || companyPhone).replace(/[^0-9]/g, '')}`} target="_blank" rel="noopener noreferrer" className="w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center text-white shadow-xl hover:scale-110 transition-transform">
